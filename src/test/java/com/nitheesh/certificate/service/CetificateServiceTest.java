...
class CetificateServiceTest {
	...
	void testgenerateSignedCerificate() throws IOException, OperatorCreationException, CertificateException, NoSuchAlgorithmException {
		...
		when(certificateDaoService.saveCertificate(Mockito.any(),Mockito.any(),Mockito.any(),Mockito.any(),Mockito.any())).thenReturn(certificateResponse);
		
		CertificateDetails details=new CertificateDetails("nitheesh","telstra","telstra software engineer","india","banglore","karnataka","nitheeshreddy290800@gmail.com","Signed","nitheeshreddy290800@gmail.com");
