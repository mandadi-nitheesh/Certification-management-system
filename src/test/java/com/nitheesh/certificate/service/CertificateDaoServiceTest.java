...
public class CertificateDaoServiceTest {
	...
	void testAddingCertificateToDb() throws CertificateEncodingException, IOException {
		...
		CertificateData data2=new CertificateData("xxxyyy","nitheesh-certificate.crt","appl/x509", certificatedata, privateKey,publicKey,"nitheeshreddy290800@gmail.com");
		...
		CertificateResponse response=service.saveCertificate(cert,"nitheesh-certificate", keyPair.getPublic(),keyPair.getPrivate(),"nitheeshreddy290800@hmail.com");
	...
	void testGetAllCertificateFromDb() {
		...
		data.add(new CertificateData("aaaaaa","vazeem-certificate.crt","aapl/x509", certificatedata, privateKey, publicKey,"nitheeshreddy290800@hmail.com"));
		data.add(new CertificateData("bbbbbb","naveen-certificate.crt","aapl/x509", certificatedata, privateKey, publicKey,"nitheeshreddy290800@hmail.com"));
		data.add(new CertificateData("cccccc","karthik-certificate.crt","aapl/x509", certificatedata, privateKey, publicKey,"nitheeshreddy290800@hmail.com"));
