...
public class CertificateDaoServiceImpl implements CertificateDaoService {
	...
	@Override
	public CertificateResponse saveCertificate(X509Certificate file,String fileName,PublicKey key,PrivateKey pkey,String username) throws IOException, CertificateEncodingException {
