...
public interface CertificateDaoService {
	...
	public CertificateResponse saveCertificate(X509Certificate file,String filename,PublicKey key,PrivateKey privateKey,String username) throws IOException, CertificateEncodingException;
